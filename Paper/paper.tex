...
these we are using RGB-D camera to take advantage of its ability to
provide both visual and depth data of the surrounding. This data is run
...
using Haptic feedback. The processing of the image and the algorithm
will be running on a SOC board running Artix-7 FPGA. The FPGA
can provide true parallel processing while maintaining
reconfigurability and programmability. This system will be mounted
on a standard white cane, reason being this piece of equipment is
already familiar and a part of the daily life for the visually impaired.
The sensor and a Zigbee transmitter is mounted on the cane while the
FPGA board along with the receiver and a power source is on person
with the user. This system will inform the user about obstacles in 5-8
